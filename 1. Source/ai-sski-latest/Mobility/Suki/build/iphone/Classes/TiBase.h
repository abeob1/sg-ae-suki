...
// in simulator we redefine to format for Suki Developer console
...
{\
	NSString * exceptionName = [@"org.suki." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.suki";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISukiNativeItemNone = -1, 
	UISukiNativeItemSpinner = -2,
	UISukiNativeItemProgressBar = -3,
	
	UISukiNativeItemSlider = -4,
	UISukiNativeItemSwitch = -5,
	UISukiNativeItemMultiButton = -6,
	UISukiNativeItemSegmented = -7,
	
	UISukiNativeItemTextView = -8,
	UISukiNativeItemTextField = -9,
	UISukiNativeItemSearchBar = -10,
	
	UISukiNativeItemPicker = -11,
	UISukiNativeItemDatePicker = -12,
	
	UISukiNativeItemInfoLight = -13,
	UISukiNativeItemInfoDark = -14,
	
	UISukiNativeItemDisclosure = -15,
	
	UISukiNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Suki instances of
